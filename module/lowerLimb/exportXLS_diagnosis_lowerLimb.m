...
% =========================================================================
% fname name:    exportXLS_diagnosis_lowerLimb
% -------------------------------------------------------------------------
...
function exportXLS_diagnosis_lowerLimb(Patient,Session,Condition,iCondition,sessionFolder,toolboxFolder)
...
xlswrite1(fname,{'Anteversion (+) / Retroversion (-) (°)' 'Anteversion (+) / Retroversion (-) (°)' 'Anteversion (+) / Retroversion (-) (°)' 'Anteversion (+) / Retroversion (-) (°)' 'Inclinaison (élévation + / chute -) (°)' 'Inclinaison (élévation + / chute -) (°)' 'Inclinaison (élévation + / chute -) (°)' 'Inclinaison (élévation + / chute -) (°)' 'Rotation (externe + / interne -) (°)' 'Rotation (externe + / interne -) (°)' 'Rotation (externe + / interne -) (°)' 'Rotation (externe + / interne -) (°)' ...
...
Excel.delete
clear Excel
system(['rename ',xlsfile.name,' ',Patient.lastname,'_',Patient.firstname,'_',regexprep(Patient.birthdate,'/',''),'_diagnosis_',regexprep(Session(iCondition).date,'/',''),'.xlsx']);
system('Taskkill /F /IM EXCEL.EXE');
cd(toolboxFolder);