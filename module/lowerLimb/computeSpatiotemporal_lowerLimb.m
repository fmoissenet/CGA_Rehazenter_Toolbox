...
% Distance parameters
% =========================================================================
Spatiotemporal.R_Stride_Length = Vmarker.R_AJC(1,:,Event.RHS(2)) - ...
    Vmarker.R_AJC(1,:,Event.RHS(1));
Spatiotemporal.L_Stride_Length = Vmarker.L_AJC(1,:,Event.LHS(2)) - ...
    Vmarker.L_AJC(1,:,Event.LHS(1));
if Event.LHS(1) < Event.RHS(1)
    Spatiotemporal.R_Step_Length = Vmarker.R_AJC(1,:,Event.RHS(1)) - ...
        Vmarker.L_AJC(1,:,Event.LHS(1));
    Spatiotemporal.L_Step_Length = Vmarker.L_AJC(1,:,Event.LHS(2)) - ...
        Vmarker.R_AJC(1,:,Event.RHS(1));
...
elseif Event.LHS(1) > Event.RHS(1)
    Spatiotemporal.R_Step_Length = Vmarker.R_AJC(1,:,Event.RHS(2)) - ...
        Vmarker.L_AJC(1,:,Event.LHS(1));
    Spatiotemporal.L_Step_Length = Vmarker.L_AJC(1,:,Event.LHS(1)) - ...
        Vmarker.R_AJC(1,:,Event.RHS(1));
