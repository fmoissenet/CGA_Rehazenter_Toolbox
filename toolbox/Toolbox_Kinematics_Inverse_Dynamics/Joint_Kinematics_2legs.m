...
function Joint = Joint_Kinematics_2legs(Segment)
...
for i = 2:4 % From i = 2 ankle (or wrist) to i = 4 hip (or shoulder)
    ...
    if i == 2
        ...
        if i == 4
            ...
            Joint(i).T(1:3,4,:) = Joint(i).T(1:3,4,:) - ...
                repmat(mean(Joint(i).T(1:3,4,:),3),[1 1 n]);
        end
...
% Joint angles and displacements
for i = 102:104 % From i = 2 ankle (or wrist) to i = 4 hip (or shoulder)
